                                ...
                                <div class="table-responsive">
                                    <form class="forms-sample" action="{{url('/admin/campaign/update')}}" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="short_description" id="description" placeholder="Description" style="height: 120px" required>{{$campaign->description}}
                                            </textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="campiagn_type" id="campiagn_type" class="form-control" required>
                                                ...
                                                <option value="{{$item->name}}" @if($item->id == $campaign->campiagn_type) selected @endif>{{$item->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
