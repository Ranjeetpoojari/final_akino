...
<div class="walpaper-img position-relative" data-aos="fade-up" data-aos-duration="2000">
    ...
    <div id="carouselExample" class="carousel slide">
        <div class="carousel-inner index_banner">
            ...
            <div class="carousel-item">
             <img src="{{url('/assets/img/indexbanner/women_akino.webp')}}" alt="" srcset="" class="w-100 img-content">
            </div>
            <div class="carousel-item ">
             <img src="{{url('/assets/img/indexbanner/education_akino.webp')}}" alt="" srcset="" class="w-100 img-content">
            </div>
            ...
            <div class="row">
                <div class="col-12 position-relative px-0 blog-container">
                    ...
                    <div class="position-absolute z-2 my-5 w-100 overflow-hidden">
                      ...
                      <div class="col-lg-8 px-4 mb-4">
                        <h3 class=""> Many Years of Dedication to Education, Food, and Support for Underprivileged Children and Communitie</h3>
                      </div>
                        <div class="owl-carousel owl-theme" id="blogslider" data-aos="fade-up" data-aos-duration="500">
                            @foreach ($activity as $item)
                            <div class="blog-card" >
                                <div class="row bg-orange">
                                    <div class="col-lg-6 px-0"><img src="{{$item->index_banner}}" alt="" srcset="" class="img-cover w-100">
                                    </div>
                                    <div class="col-lg-6 py-4 px-5 h-320">
                                        <a href="{{ url('/activitydetail', ['encryptedId' => encrypt($item->id)]) }}" class="text-decoration-none"><h4 class="text-white fs-20 heading-content">{{$item->title}},</h4></a>
 ...
 <section class="my-5">
    <div class="container ">
        ...
        <div class="px-0 d-flex  justify-content-center flex-wrap">
                <img src="{{url('/assets/img/supporters/whizzactpvt.webp')}}" alt="" height="50" srcset="" class="mx-4 my-3">
                <img src="{{url('/assets/img/supporters/axis.webp')}}" alt="" height="50"  srcset="" class=" mx-4 my-3">
                <img src="{{url('/assets/img/supporters/icicibank.webp')}}" alt="" height="50"   srcset="" class=" mx-4 my-3">
                <img src="{{url('/assets/img/supporters/phonepe.webp')}}" alt="" height="50"  srcset="" class="mx-4 my-3">
                <img src="{{url('/assets/img/supporters/razorpay.webp')}}" alt="" height="50"   srcset="" class="mx-4 my-3">
                <img src="{{url('/assets/img/supporters/inorbit.webp')}}" alt="" height="50"  srcset="" class=" mx-4 my-3">
                <img src="{{url('/assets/img/supporters/crossword.webp')}}" alt="" height="50"  srcset="" class="mx-4 my-3">
                <img src="{{url('/assets/img/supporters/kfc.webp')}}" alt="" height="50"  srcset="" class="mx-4 my-3">
                <img src="{{url('/assets/img/supporters/pvr.webp')}}" alt="" height="50"   srcset="" class="mx-4 my-3">
                <img src="{{url('/assets/img/supporters/grand-center.webp')}}" alt="" height="50"  srcset="" class="mx-4 my-3">
        </div>
